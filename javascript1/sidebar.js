...
<div class="sidebar-list">
    ...
    <a href="movielist.html" menu-close  class="sidebar-link"onclick='getMovieList("with_original_language=bn","Bengali")'>Bengali</a>
    
    </div>

    <div class="sidebar-footer">
        <img src="images/netflix.png" width="50" height="17" alt="netflix-logo">    

   <p class="copyright">
    copyright2024@alright-reserved
   </p> 
...
const togglesidebar=function(sidebar)
{
    ...
    //Toogle sidebarvin mobilescreen
